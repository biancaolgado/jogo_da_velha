...
let bob = "url('img/bob.png')";
let patrick = "url('img/patrick.jpg')";
let gordar = "url('img/gordar.jpg')";
let lular = "url('img/lular.jpeg')";
let siri = "url('img/siri.jpg')";
let cara = "url('img/cara.jpg')";
...
poke1.style.backgroundImage = bob;
poke2.style.backgroundImage = patrick;
poke3.style.backgroundImage = gordar;
poke4.style.backgroundImage = lular;
poke5.style.backgroundImage = siri;
poke6.style.backgroundImage = cara;
...
function clickPoke(pokemonSelecionado) {
    ...
    if (pokemonSelecionado == 'bob') {
        jogadorSelecionado = bob;
    } else if (pokemonSelecionado == 'patrick') {
        jogadorSelecionado = patrick;
    } else if (pokemonSelecionado == 'gorda') {
        jogadorSelecionado = gorda;
    } else if (pokemonSelecionado == 'lular') {
        jogadorSelecionado = lular;
    } else if (pokemonSelecionado == 'siri') {
        jogadorSelecionado = siri;
    } else if (pokemonSelecionado =='cara') {
        jogadorSelecionado = cara;
    }
